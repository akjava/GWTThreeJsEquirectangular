...
public class OceanApp extends AbstractApp{
	...
	public void init(FocusPanel container,double w,double h) {
		...
		cubeCamera.setPosition(0, 100, 0 );
		cubeCamera.getRotation().setX(Math.toRadians(-90));
		
		
		controls = THREEExp.OrbitControls( group, renderer.getDomElement());//controls = new THREE.OrbitControls( camera, renderer.domElement );
...
//waternormals
	...
	private void initResizeHandlerAndGUI() {
		VerticalPanel gui=new VerticalPanel();//TODO add
...
*/
	...
	public void update() {//GWT animateFrame has time
